<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Currency {
        ...
        public static function conversion($value=1, $from, $to){
            ...
            //Runs the Google exchange by default
            $exchange = self::google( $from, $to );

            if ( !$exchange ){
                //If there is an error in Google, Yahoo runs
	...
	// echo Currency::conversion(1,'USD','COP');
